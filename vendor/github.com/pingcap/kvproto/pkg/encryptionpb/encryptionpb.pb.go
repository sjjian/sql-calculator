...
func (EncryptionMethod) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{0}
}
...
func (*FileInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{1}
}
...
func (*FileDictionary) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{2}
}
...
func (*DataKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{3}
}
...
func (*KeyDictionary) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{4}
}
...
func (*MasterKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{5}
}
...
func (*MasterKeyPlaintext) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{6}
}
...
func (*MasterKeyFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{7}
}
...
func (*MasterKeyKms) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{8}
}
...
func (*EncryptedContent) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_962659f950b73822, []int{9}
}
...
func init() { proto.RegisterFile("encryptionpb.proto", fileDescriptor_encryptionpb_962659f950b73822) }

var fileDescriptor_encryptionpb_962659f950b73822 = []byte{
